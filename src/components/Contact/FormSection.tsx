...
export default function ContactForm({title, success, error, form}: FormSectionProps) {
  ...
  return (
    ...
    >
      ...
      <form onSubmit={handleSubmit} className="grid grid-cols-2 gap-4">
        ...
        <button
          type="submit"
          className="bg-black hover:bg-orange-500 transition-all duration-300 text-white font-bold py-2 px-4 mt-4 col-span-2"
        >
          {form.button}
        </button>
      </form>
