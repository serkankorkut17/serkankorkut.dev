...
// Sidebar Links
const SidebarContent = ({ toggleSidebar }: SidebarContentProps) => {
	...
	return (
		<div className="h-full px-3 py-2 md:p-0 md:pb-4 overflow-y-auto bg-white dark:bg-black">
				...
				{user && (
					<>
						<li>
							...
							>
								<svg
									className="w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white transform scale-125"
						...
						<li>
							...
							>
								<svg
									className="w-5 h-5 transition duration-75 text-gray-500 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white transform scale-150"
									xmlns="http://www.w3.org/2000/svg"
									fill="currentColor"
									viewBox="0 0 24 24"
								>
				...
				{!user && (
					<>
						<li>
							...
							>
								<svg
									className="w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white scale-125"
									aria-hidden="true"
									xmlns="http://www.w3.org/2000/svg"
									fill="none"
									viewBox="0 0 18 16"
								...
								<span className="flex-1 ms-3 inline-flex sm:hidden md:inline-flex whitespace-nowrap">
									Sign In
								</span>
							</Link>
						</li>
				...
				{user && (
					<>
						<li>
							...
							>
								<svg
									...
									viewBox="0 0 24 24"
								>
									<path d="M19.14 12.94c.04-.3.06-.61.06-.94 0-.32-.02-.64-.06-.94l2.03-1.58a.49.49 0 0 0 .12-.61l-1.92-3.32a.488.488 0 0 0-.59-.22l-2.39.96c-.5-.38-1.03-.7-1.62-.94l-.36-2.54a.484.484 0 0 0-.48-.41h-3.84a.49.49 0 0 0-.49.41l-.36 2.54c-.59.24-1.13.56-1.62.94l-2.39-.96a.488.488 0 0 0-.59.22l-1.92 3.32a.487.487 0 0 0 .12.61l2.03 1.58c-.04.3-.06.62-.06.94 0 .32.02.64.06.94l-2.03 1.58a.49.49 0 0 0-.12.61l1.92 3.32a.487.487 0 0 0 .59.22l2.39-.96c.5.38 1.03.7 1.62.94l.36 2.54a.484.484 0 0 0 .48.41h3.84a.49.49 0 0 0 .49-.41l.36-2.54c.59-.24 1.13-.56 1.62-.94l2.39.96a.488.488 0 0 0 .59-.22l1.92-3.32a.487.487 0 0 0-.12-.61l-2.03-1.58zM12 15.6c-1.98 0-3.6-1.62-3.6-3.6s1.62-3.6 3.6-3.6 3.6 1.62 3.6 3.6-1.62 3.6-3.6 3.6z" />
								</svg>
								<span className="ms-3 inline-flex sm:hidden md:inline-flex">
									Settings
								</span>
						...
						<li>
							...
							>
								<svg
									className="w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white scale-x-125"
									aria-hidden="true"
									xmlns="http://www.w3.org/2000/svg"
									fill="none"
									viewBox="0 0 18 16"
								...
								<span className="flex-1 ms-3 inline-flex sm:hidden md:inline-flex whitespace-nowrap text-left">
									Logout
								</span>
							</button>
						</li>
