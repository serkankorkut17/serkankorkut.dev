      ...
      <div className="text-black flex flex-col xl:flex-row justify-between items-center">
        <div className="w-[90%] sm:w-[75%] xl:w-[31%] bg-gray-100 py-4 rounded-lg shadow-md flex flex-row mb-8">
          ...
          <div className="w-3/4 flex flex-col">
            ...
            <Link href={location.link} className="font-medium text-gray-600 hover:text-orange-500 transition-colors duration-300 mt-2">{location.address}</Link>
          </div>
        </div>
        ...
        <div className="w-[90%] sm:w-[75%] xl:w-[31%] bg-gray-100 py-4 rounded-lg shadow-md flex flex-row mb-8">
          ...
          <Link href={phone.link} className="font-medium text-gray-600 hover:text-orange-500 transition-colors duration-300 mt-2">{phone.number}</Link>
          </div>
        </div>
        ...
        <div className="w-[90%] sm:w-[75%] xl:w-[31%] bg-gray-100 py-4 rounded-lg shadow-md flex flex-row mb-8">
          ...
          <Link href={email.link} className="font-medium text-gray-600 hover:text-orange-500 transition-colors duration-300 mt-2">{email.email}</Link>
          </div>
        </div>
      </div>
    </section>
